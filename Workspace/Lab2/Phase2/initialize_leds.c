...
void InitializeGPIO() { 
    ...
    // PA0
    // IOMUX_PINCMx found in datasheet Table 6-2
    ...
    GPIOA->DOUTSET31_0 = LED12A_bit; // initialize LED OFF (active LOW)
    GPIOA->DOESET31_0 = LED12A_bit; // enables output driver
    // PA1
    IOMUX->SECCFG.PINCM[(IOMUX_PINCM2)] = (IOMUX_PINCM_PC_CONNECTED | ((uint32_t) 0x00000001));
    GPIOA->DOUTSET31_0 = LED11B_bit;
    GPIOA->DOESET31_0 = LED11B_bit;
    // PA5
